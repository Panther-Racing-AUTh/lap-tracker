      ...
      return new Query(
        ...
        builder: (result, {fetchMore, refetch}) {
          ...
          if (!result.source!.isEager) {
            ...
            if (setup.proposalVehicle == Vehicle.empty())
                    ...
                    actions: [
                      ...
                      TextButton(
                        ...
                        onPressed: !((int.tryParse(change.text) != null) &&
                            ...
                            ? null
                            : () {
                                print(selectedPart.id);
                                print(selectedPart.name);
                                print(selectedPart.measurementUnit);
                                print(setup.supabase_id);
                                print(setup.role);
                                print(setup.userDepartment);
                                print(title.text);
                                print(description.text);
                                print(reason.text);
                                print(currentProposalPoolId);
                                print(selectedPart.value.toString() +
                                    ' ' +
                                    selectedPart.measurementUnit);
                                print(change.text.toString() +
                                    ' ' +
                                    selectedPart.measurementUnit);
                ...
                itemBuilder: ((context, index1) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      ...
                      print(widget.subsystems[index].parts[index1].id);
                    },
                    child: Card(
